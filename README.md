...
You can either [download](http://github.com/jagomf/flag-icon-css/archive/main.zip) the whole project as is or install it via npm or Yarn:
...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/gh/jagomf/flag-icon-css@7.2.3/css/flag-icons.min.css"
/>
```
